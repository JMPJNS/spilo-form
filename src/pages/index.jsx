          ...
          <div className="flex flex-auto">
            ...
            <div className="grid flex-auto grid-cols-1 grid-rows-1">
              ...
              >
                ...
                <li className="relative mt-px flex sm:col-start-2" style={{ gridRow: '91 / span 19' }}>
                  <a
                    href="#"
                    className="group absolute inset-1 flex flex-col overflow-y-auto rounded-lg bg-blue-50 p-2 text-xs leading-5 hover:bg-blue-100"
                    onClick={() => setShowModal(true)}
                ...
                <li className="relative mt-px flex sm:col-start-3" style={{ gridRow: '91 / span 19' }}>
                  <a
                    href="#"
                    className="group absolute inset-1 flex flex-col overflow-y-auto rounded-lg bg-blue-50 p-2 text-xs leading-5 hover:bg-blue-100"
                    onClick={() => setShowModal(true)}
                    ...
                    <>
                      <form class="w-full max-w-lg">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                          ...
                          <div class="relative">
                              <select class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-coaching-type">
